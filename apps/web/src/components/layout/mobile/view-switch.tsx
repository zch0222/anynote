...
export function ViewSwitch({ className }: { className?: string }) {
  ...
  return (
    <Link
      ...
      className={cn(
        "inline-flex min-h-10 items-center gap-2 rounded-lg px-3 text-sm text-label-secondary outline-none transition-colors hover:bg-fill-hover hover:text-label focus-visible:ring-2 focus-visible:ring-ring",
        className,
      )}
    >
