...
INSERT INTO `sys_config` VALUES (1,'OSS_TYPE','MIN_IO','对象存储类别'),(2,'HUAWEI_OBS_CONFIG','{\"endPoint\": \"obs.cn-east-3.myhuaweicloud.com\",\"accessKey\": \"\",\"accessSecret\": \"\",\"bucketName\": \"anynote\",\"basePath\": \"anynote_Shanghai_one\"}','华为对象存储配置'),(3,'AI_SERVER_ADDRESS','http://anynote-langchain',''),(4,'TRANSLATE_TYPE','DEEPL',''),(5,'DEEPL_CONFIG','{\"textTranslateEndPoint\": \"https://api-free.deepl.com/v2/translate\",\"token\": \"\"}',''),(6,'RAG_MAX_DAY_COUNT','50',''),(7,'HOME_DOC_ID','50','首页展示文档'),(8,'GREEN_TYPE','ALI_GREEN','内容安全检测类型'),(9,'ALI_GREEN_CONFIG','{\"endpoint\": \"green-cip.cn-shanghai.aliyuncs.com\",\"alibabaCloudAccessKeyId\": \"\",\"alibabaCloudAccessKeySecret\": \"\"}','阿里云内容安全检测配置'),(10,'AI_SERVER_API_KEY','',''),(11,'MIN_IO_CONFIG','{\"endPoint\": \"http://minio:9000\",\"publicEndPoint\": \"http://localhost:9000\",\"region\": \"us-east-1\",\"accessKey\": \"\",\"secretKey\": \"\",\"bucketName\": \"anynote\",\"basePath\": \"anynote_Shanghai_one\"}','MinIO配置'),(12,'WHISPER_CONFIG','{\"baseUrl\": \"\",\"apiKey\": \"\", \"tmpFileFolder\": \"/Users/zch/code/anynote/tmpWhisperFolder\"}','');
